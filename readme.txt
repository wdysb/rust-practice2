# Інструкція до виконання практичних робіт №3–108
...
3. Орієнтир по структурі директорій: https://github.com/djnzx/rust-practice2/tree/master/src/hackerrank
...
3. Приклад оформлення тесту: https://github.com/djnzx/rust-practice2/blob/master/src/hackerrank/task0.rs#L11
...
2. Зробити скріншот з локального компʼютера, де видно:
   ...
   * приклад коректного результату: https://github.com/djnzx/rust-practice2/blob/master/src/hackerrank/results/0/rust2-example0-console-no-warning.png

3. Якщо є warnings — робота не зараховується.

   * Приклад некоректного результату: https://github.com/djnzx/rust-practice2/blob/master/src/hackerrank/results/0/rust2-example0-console-warning.png
...
Приклад історії комітів: https://github.com/djnzx/rust-practice2/commits/master
